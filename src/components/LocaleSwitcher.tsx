...
export default function LocaleSwitcher({ locale }: LocaleSwitcherProps) {
  ...
  return (
    <Link
      href={href}
      className="rounded-full border border-white/20 px-3 py-1 text-xs font-semibold tracking-wide text-white/80 transition hover:border-amber-300 hover:text-amber-200"
